...
file = open('C://Users//Rafael//Documents//blender objects//orenodes.obj', 'r').read()
...
for shape in newshapes:
   # print('e',shape)
    ...
    for i in range(len(shape)-2):
       # print(shape)
        triangles.append([[newvertices[shape[0][0]-1], newtexturecoords[shape[0][1]-1]], [newvertices[shape[i+1][0]-1], newtexturecoords[shape[i+1][1]-1]], [newvertices[shape[i+2][0]-1], newtexturecoords[shape[i+2][1]-1]], shapecolor,0,0])
  #  for vertex in shape:
